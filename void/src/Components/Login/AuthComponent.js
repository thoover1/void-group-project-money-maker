        ...
        >
          ...
          {!register && (
            <button
              className="switcher"
              onClick={() => {
                this.setState({ register: true, failed: false });
          ...
          {register && (
            <button
              className="switcher"
              onClick={() => {
                this.setState({ register: false, failed: false });
...
const enhancedComponent = connect(mapReduxSateToProps, mapDispatchToProps);
